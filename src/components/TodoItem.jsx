...
const TodoItem = ({ todo, toggleTodo, deleteTodo, index, dragItem, dragOverItem, handleDragEnd }) => {
  return (
    <li
      className=" font-sans border-b border-gray-200 dark:border-gray-700 relative"
      draggable
    ...
    >
      <div className="px-4 py-4 flex items-center">
        <div
          ...
          className={classnames("w-5 h-5 rounded-full border-2 flex font-sans  items-center justify-center cursor-pointer", {
        ...
        <span className={classnames("ml-4 flex-1 font-sans ", { "line-through text-gray-400": todo.completed })}>
          {todo.text}
        </span>
